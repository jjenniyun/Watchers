		...
		<div
			...
			<nav id="navbar" class="navbar">
				<ul>
					...
					<li><a href="${cpath }/cctv_event.do" class="active">영상 기록</a></li>
	...
	<main id="main">
		...
		<section id="about" class="about">
			<div class="container" data-aos="fade-up" style="text-align: center">
				<h3 style="text-align: center; font-family: 'Do Hyeon', sans-serif;">영상
					기록</h3>
				<br>
				<!-- 검색창 -->
				...
				<table class="table">
					...
					<tbody>
						<c:forEach items="${nlist}" var="no" varStatus="status">
							<tr>
								<td>${status.count+(paging2.curPage-1)*10 }</td>
								<td><a href="${cpath }/cctv_view.do/${no.noti_no}">${no.noti_name }</a></td>
								<td>${no.noti_time }</td>
							</tr>
						</c:forEach>
					</tbody>
	...
	<nav aria-label="Page navigation example"
		...
		<ul class="pagination">
			<li class="page-item"><a class="page-link"
				href="${cpath }/cctv_event.do?curPage=1" aria-label="First"> <span
					aria-hidden="true">&laquo;</span>

					<li class="page-item"><a class="page-link"
						href="${cpath }/cctv_event.do?curPage=${paging2.curPage-1 }"
						aria-label="Previous"> <span aria-hidden="true">&lt</span> 
					<c:forEach begin="${paging2.firstPage }" end="${paging2.lastPage }" var="i"></a></li>
					<li class="page-item"><a class="page-link"
						href="${cpath }/cctv_event.do?curPage=${i }"> 
					...
					<li class="page-item"><a class="page-link"
						href="${cpath }/cctv_event.do?curPage=${paging2.totalPageCount }"
