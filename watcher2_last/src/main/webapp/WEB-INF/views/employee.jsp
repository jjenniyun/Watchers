      ...
      <div id="community">
        <div id="bar">
          <ul>
            ...
            <li><a href="${cpath }/cctv_event.do">영상관리</a></li>
          </ul>
        </div>
        <hr />
         
        <div id="board">
          <h4 style="font-family: 'Do Hyeon', sans-serif;">근무자 등록</h4>
          <br>
          <form action="${cpath}/empJoin.do" method="post">
          <table
            ...
            <tbody>
              <tr>
                ...
                <th scope="col" style="border-right-style: hidden">
                  <input name = "emp_pw" type="password" style="text-align: center" />
                </th>
                <th></th>
              </tr>
              <tr>
                <th scope="row">이름</th>
                <th scope="col" style="border-right-style: hidden">
                  <input name = "emp_name" type="text" style="text-align: center" />
                </th>
                <th></th>
              </tr>
              <tr>
                <th scope="row">연락처</th>
                <th scope="col" style="width: 60%; border-right-style: hidden">
                  <input name ="emp_phone" type="text" style="text-align: center" />
                </th>
                <th></th>
              </tr>
            </tbody>
          ...
          <br>
          <button class="btn btn-primary" type="submit" style="margin-left:400px" data-bs-toggle="modal" data-bs-target="#dialog">등 록</button>
        </div>
      </div>
