				...
				<form action="${cpath }/boardUpdate.do" method="post">
						...
						<thead>
							<tr>
								...
								<td scope="col" colspan="3"><input type="text"
									name="bo_title" value="${vo.bo_title}" class="form-control"
						...
						<tbody>
							<tr>
								...
								<td colspan="3" style="text-align: left;"><textarea rows="15" class="form-control"
										id="content" name="bo_content" value="">${vo.bo_content}</textarea>
								</td>
							</tr>
							<!-- <tr>
					...
					<div class="d-grid gap-2 d-md-block" style="text-align: center">
						<button class="btn btn-primary" type="submit"
							data-bs-toggle="modal" data-bs-target="#dialog">수 정</button>
						<div class="space"></div>
						<button class="btn btn-danger" type="button"
						onclick="location.href='${cpath }/community.do'">취소</button>
					</div>
				</form>
			</div>
		</section>
